...
//   { label: 'Үр өмнөх', value: 'Pre-seed', group: 'Хөрөнгө оруулалтын үе шат' },
//   { label: 'Үр', value: 'Seed', group: 'Хөрөнгө оруулалтын үе шат' },
//   { label: 'А Цуврал', value: 'Series A', group: 'Хөрөнгө оруулалтын үе шат' },
//   { label: 'Б Цуврал', value: 'Series B', group: 'Хөрөнгө оруулалтын үе шат' },
//   { label: 'Өсөлт', value: 'Growth', group: 'Хөрөнгө оруулалтын үе шат' },
  
//   // Хөрөнгө оруулалтын сонирхлын сонголтууд
//   { label: 'Финтек', value: 'Fintech', group: 'Салбарын чиглэл' },
//   { label: 'SaaS', value: 'SaaS', group: 'Салбарын чиглэл' },
//   { label: 'Цэвэр эрчим хүч', value: 'Clean Energy', group: 'Салбарын чиглэл' },
//   { label: 'ХАА технологи', value: 'AgTech', group: 'Салбарын чиглэл' },
//   { label: 'Цахим худалдаа', value: 'E-commerce', group: 'Салбарын чиглэл' },
//   { label: 'Логистик', value: 'Logistics', group: 'Салбарын чиглэл' },
//   { label: 'БоловсролТех', value: 'EdTech', group: 'Салбарын чиглэл' },
//   { label: 'Эрүүл мэнд', value: 'Healthcare', group: 'Салбарын чиглэл' },
//   { label: 'Мобайл апп', value: 'Mobile Apps', group: 'Салбарын чиглэл' },
//   { label: 'Хэрэглэгчийн технологи', value: 'Consumer Tech', group: 'Салбарын чиглэл' },
